        ...
        stage('Deployable to Dev package')
{
    ...
    sh 'scp -o StrictHostKeyChecking=no */target/webapp.war ec2-user@13.234.202.200:/var/lib/tomcat/webapps'
}}}

        stage('sonar analysis& create package')
{
    steps{withSonarQubeEnv(installationsName: 'sonar' , credentialsId: 'sonar') {
